...
router.get('/bilibili/user/dynamic_mstdn/:uid/:disableEmbed?', require('./routes/bilibili/dynamic_mstdn'));
...
router.get('/google/translate/:to/:sha/:type?/:sl?/:domain?', require('./routes/google/translate'));
